                ...
                <div className="w-full h-56 lg:h-64 relative rounded-2xl">
                   <div className="absolute w-full bottom-4 flex items-end justify-between">
                    <div className="flex flex-col gap-2 items-start">
                        {props.isPro && (
                            <span className="bg-zomato-400 text-white px-2 py-1 rounded text-sm">Pro extra 15% OFF</span>
                        )}
                          {
                              props.isOff && (
                                <span className="bg-blue-600 text-white px-2 py-1 rounded">₹{`${props.isOff}`} OFF</span>
                              )
                          }  
                ...
                <div className="my-2 flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="bg-green-800 text-white text-sm p-1 rounded flex items-center">
                            {props.restaurantReviewValue} <BsStarFill /> 
                        </span>
                    </div>
